...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'brunch-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'brunch-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'brunch-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'brunch-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'brunch-pro' ),
		'devanagari'   => __( 'Devanagari', 'brunch-pro' ),
		'greek'        => __( 'Greek', 'brunch-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'brunch-pro' ),
		'khmer'        => __( 'Khmer', 'brunch-pro' ),
		'latin'        => __( 'Latin', 'brunch-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'brunch-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'brunch-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'brunch-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'brunch-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'brunch-pro' ),
