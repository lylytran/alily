(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        var $optionEnDisStat = $('.options-wp input[name="enable-disable-statistic"]')
        ,   $optionSharesLog = $('.options-wp input[name="shares-log-statistic"]')
        ,   $optionViewsLog = $('.options-wp input[name="views-log-statistic"]');
