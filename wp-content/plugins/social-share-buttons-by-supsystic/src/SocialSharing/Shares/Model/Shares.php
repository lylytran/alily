...
class SocialSharing_Shares_Model_Shares extends SocialSharing_Core_BaseModel
{
    ...
    public function getIsEnableOption()
    {
        return (bool) get_option(self::$optionKeys['isEnable'], true);
    }

    public function getSharesLogOption()
    {
        return (bool) get_option(self::$optionKeys['sharesLog'], true);
    }

    public function getViewsLogOption()
    {
        return (bool) get_option(self::$optionKeys['viewsLog'], true);
    }
